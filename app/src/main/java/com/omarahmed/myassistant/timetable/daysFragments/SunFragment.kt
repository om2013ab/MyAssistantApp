...
import com.omarahmed.myassistant.databinding.FragmentSunBinding
...
class SunFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = FragmentSunBinding.inflate(inflater)
        ...
        binding.fabSunday.setOnClickListener {
            setupAddSchedule()
        }
        binding.rvSunday.adapter = timetableAdapter
        timetableViewModel.getSchedule("Sunday").observe(viewLifecycleOwner,  {
    ...
    private fun insertNewSchedule(view: DialogAddSchedualBinding, dialog: AlertDialog) {
        ...
        val newSchedule = TimetableInfo(0, name, from, to, venue,"Sunday")
